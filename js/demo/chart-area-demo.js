...
function getFixCosts(){
  ...
  return parseInt(document.getElementById("fixCost" + i).value)

}

function getVarCosts(){
  return  parseInt(document.getElementById("variableCost" + i).value);
}

function costsPieChart(){
  ...
  var chart = new Chart(canvas, {
      ...
      data: {
        ...
        datasets: [{
            ...
            pointBackgroundColor: 'rgba(219,68,55,1.0)',
      ...
      options: {
          ...
          title: {
              display: true,
              text: '% de meios de acesso aos materiais',
              fontColor: '#fff',
              fontSize: '20'
          },
          scale: {
